...
public class RestrictedDPAlgorithm
{
	// list of states
	...
	public RestrictedDPAlgorithm(Map<Short,Node> nodeMapping, ArrayListSet cities,ArrayListSet depotBeginNodes,ArrayListSet depotEndNodes, int H, int E, double vehicleCapacity, double[][] distances, ArrayList<Short> customerNodes)
	{
	...
	{	
		...
		ArrayListSet feasibleJ = getFeasibleJExpansions(i,currentSubSetToExpand,listSToExpand);
		...
		{	
			...
			if(enoughCapacity(remainingCustomers, setJ,vehicleCapacity,j) && timeFeasible(remainingCustomers, setJ,currentStateReleaseTime, minDistance, j))
			{
				// update new capacity
				...
				{	
					...
					for(State nextPreviousState:nextPreviousStates)
					{
						if(nextPreviousState != currentState)
						{
							...
							ArrayListSet setPossibleJ = getFeasibleJExpansions(i,nextPreviousState.getS(), nextPreviousState.getListS());
	...
	public ArrayListSet getFeasibleJExpansions(Short i, ArrayListSet currentSubSetToExpand, ArrayList<Short> listSToExpand)
	{	
